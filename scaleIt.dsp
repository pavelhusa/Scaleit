...
gameAccord = input : par(i, inputsN, _ <: (envelope <: _,_), (toFrequency(i) <: ((synth, tunedNoise) :> _), bassSynth(i)) : _,ro.cross(2),_ : par(i, 2, (_*_))) : par(i, inputsN, panorama(i), sp.panner(0.5))
with {
    toFrequency(n) = ba.midikey2hz(baseKeyMIDI+getTone(n));
